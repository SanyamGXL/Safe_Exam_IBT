...
import { LoginDetails } from "../component/LoginPage/page";

type Props = {
    loginData : LoginDetails
}

export default function LoginProps({loginData}:Props) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    ...
    >
      ...
      <Image height={50} width={80} src={"/logo/logo.png"} style={{ width: "auto", height: "auto" }} alt="logo" />
