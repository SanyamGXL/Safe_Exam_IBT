...
export function StudentDataByID({ dataType }: Props) {
  ...
  const { id: wallet_address } = useParams();
  ...
  return (
    ...
    <div className="max-w-screen-lg mx-auto w-full">
      <h1 className="text-xl font-bold mb-6">Anomaly Detected Student</h1>
      {loading ? (
...
export default StudentDataByID;
